  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute right-0 top-0 h-screen w-full overflow-scroll bg-base-300 p-8 lg:w-1/3 md:w-1/2"
      >
          ...
          <>
            ...
            {cartStore.cart.map((item) => (
              <motion.div
                layout
                key={item.id}
                className="my-4 flex gap-4 rounded-lg bg-base-100 p-4 py-4"
              >
                <Image
                  src={item.image}
                  width={120}
